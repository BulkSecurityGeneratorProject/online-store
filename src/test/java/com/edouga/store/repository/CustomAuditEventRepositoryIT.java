package com.edouga.store.repository;

import com.edouga.store.StoreApp;
import com.edouga.store.config.Constants;
import com.edouga.store.config.audit.AuditEventConverter;
import com.edouga.store.domain.PersistentAuditEvent;
...
import static com.edouga.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
